 ...
 */
final class Version20241024121306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media ADD parent_id INT DEFAULT NULL, ADD version INT NOT NULL, ADD is_current_version TINYINT(1) DEFAULT 1 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media DROP parent_id, DROP version, DROP is_current_version');
    }
}
